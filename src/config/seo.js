...
export const seoPages = [
  ...
  page(
    ...
    "ANOVA Explorer | BioassayCraft",
    "Explore variance decomposition, model assumptions, and ANOVA decisions for bioassay data.",
  ),
  page(
    "/learn/ci-explorer/",
    "Confidence Interval Explorer | BioassayCraft",
    "Understand confidence intervals, uncertainty, and statistical inference in bioassay results.",
  ),
  page(
    "/learn/residual-explorer/",
    "Residual Explorer | BioassayCraft",
    "Explore residual distributions and model assumptions for bioassay models.",
  ),
  page(
    "/tools/converter/",
    "Concentration Unit Converter | BioassayCraft",
    "Convert scientific concentration units for bioassay work.",
  ),
  page(
    "/tools/cfd-calculator/",
    "CFD Critical Fold Difference Calculator | BioassayCraft",
    "Calculate critical fold difference from validation variance components.",
  ),
  page(
    "/tools/specification-limit-calculator/",
    "Specification Limit Calculator | BioassayCraft",
    "Build a specification-limit calculation workflow for bioassay development.",
  ),
  page(
    "/tools/oos-risk-explorer/",
    "OOS Risk Explorer | BioassayCraft",
    "Explore how bias, precision, and specification limits shape OOS probability.",
  ),
  page(
    "/tools/validation-sample-size-calculator/",
    "Validation Sample Size Calculator | BioassayCraft",
  ...
  page(
    "/404",
    "Page not found | BioassayCraft",
    "The requested BioassayCraft page could not be found.",
    { index: false, type: "website" },
  ),
];
